...
function initializeMap() {
    // Map options
    var opts = {
        center: new google.maps.LatLng(1.35179, 103.88870),
        zoom: 18,
        streetViewControl: false,
        mapTypeControl: false,
    };
    map = new google.maps.Map(document.getElementById('map-canvas'), opts);
       map.data.loadGeoJson('results.json');
...
<h2>SmartBus - Route Planner (Cognita - Demo)</h2></td><td>
    <table>
        ...
        <tr>
            <td>Max Generations (will take longer time if exceeds 50): </td>
            <td>
        ...
        <tr class="ga-info" style="display:none;">
            <td>Best Time (based on average traffic): </td><td id="best-time">?</td>
        </tr>
        <tr id="ga-buttons">
