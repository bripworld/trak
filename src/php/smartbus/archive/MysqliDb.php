...
class MysqliDb
{
     ...
     * @var string
     */
    protected $host="aa1k0mfivovxj1v.csowqwfczvsc.ap-southeast-1.rds.amazonaws.com";
    protected $username="smartbus";
    protected $password="smartbus";
    protected $db="smartbus";
    protected $port;
