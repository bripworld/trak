<html>
	<head>
		<Title>SmartBus - Route Planner (Cognita - Demo)</Title>
		<script src="https://maps.googleapis.com/maps/api/js?v=3.exp&key=AIzaSyCh2_PcheSwNgMt-Ac4jqpkQwD8TcBfbYo"></script>
		...
		<script type="text/javascript">
			...
			function initializeMap() {
				// Map options
				var opts = {
					center: new google.maps.LatLng(1.3456332, 103.8605488),
					zoom: 18,
				...
				map.data.loadGeoJson('address.json');
				map.data.setStyle({icon: 'img/marker-house.png'});

				map.data.addListener('click', function(event) {
					//show an infowindow on click
					infoWindow.setContent('<div style="line-height:1.35;overflow:hidden;white-space:nowrap;">'+
					event.feature.getProperty("id") +": <b>"+event.feature.getProperty("name")+"</b><br/>"+event.feature.getProperty("address")+", "+event.feature.getProperty("pin")+"</div>");
		...
		<div>
			...
			<div>
				<table><tr><td width="50%">
					<img src="img/logo.png" border="0px" />
				<h2>SmartBus - Route Planner (Cognita - Demo)</h2></td><td>
					<table>
						<tr>
							<td colspan="2"><b>Configuration</b>
								<br/>
							<b>Max bus stops restricted at 10</b></td>
							</tr>
							<tr>
								<td>Travel Mode: </td>
								<td>
							...
							<tr>
								<td style="display:none;">Population Size: </td>
							...
							<tr>
								<td style="display:none;">Mutation Rate: </td>
								<td style="display:none;">
							...
							<tr>
								<td style="display:none;">Crossover Rate: </td>
								<td style="display:none;">
							...
							<tr>
								<td style="display:none;">Elitism: </td>
								<td style="display:none;">
									<select id="elitism">
							...
							<tr>
								<td style="display:none;">Max Generations (will take longer time if exceeds 50): </td>
								<td style="display:none;">
							...
							<tr>
								<td colspan="2"><b>Debug Info / dev only, not for AU installations</b></td>
							</tr>
							<tr>
							...
							<tr class="ga-info">
								<td>Best Time (current traffic conditions): </td><td id="best-time">?</td>
							</tr>
							<tr id="ga-buttons">
				...
				<div id="map-canvas" style="width:80%; height:65%;"></div>
			</body>
		</html>