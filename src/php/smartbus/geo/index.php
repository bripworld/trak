...
//$lat = "37.4419";
//$lng = "-122.1419";
      echo "\t\tloadAtStart(1.35179, 103.88870, " . $zoom . ");\n";
      echo "\t}\n";
    }
...
<img src="img/logo.png" border="0px" /><br/>
<h2>SmartBus Route Planner - Cognita Demo (Screen Only)</h2>
<?php
if (!$hidePoll1) {
  echo "<div class='poll'>
...
<tr>
  ...
  <h3><a href="#" class='accHeader'>Options for Route</a></h3>
  <div>
  ...
  <div>
  <p><span class="red">Version 1</span>&nbsp;<a href="http://www.trakkids.com">TrakKids.com</a></p>
  </div>
